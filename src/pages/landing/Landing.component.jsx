...
const Landing = ({ history, auth: { isAuthenticated, user } }) => {
  return (
    <React.Fragment>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Home | Semoto </title>
      </Helmet>
      <div className="landing">
        <div className="landing-logo">
          <img src="semoto-logo.png" alt="Logo" />
          <span className="landing-logo-text">Semoto</span>
        </div>
        <Alert />
        {isAuthenticated ? (
          ...
          <div className="landing-info">
            ...
            produktiver und zufriedener zu sein. <br /> <br /> Semoto ist kein
            Terminkalender sondern vielmehr eine Möglichkeit die nächsten Tage
            zu strukturieren und einen Überblick über alle anstehenden Aufgaben
            zu bekommen.
            <Button
              type="button"
